...
``` {r firstiteration, echo=FALSE, fig.margin = TRUE, fig.cap = "AdaBoost's first tree starts off with equal weights. Predicted values of 0 for Y go to the left; Predicted values of 1 go to the right. The true proportions are described inside the boxes.", fig.width=3.5, fig.height=3.5, cache=TRUE, message=FALSE}
par(bg="#fffff8")
...
``` {r seconditeration, echo=FALSE, fig.margin = TRUE, fig.cap = "This is the tree from AdaBoost's second iteration. In this tree and all subsequent trees, the weights differ across the observations and, so, the weighted proportion of correct (and incorrect) observations in each branch begins to change.", fig.width=3.5, fig.height=3.5, cache=TRUE, message=FALSE}
par(bg="#fffff8")
...
``` {r boostplotweak, echo=FALSE, fig.margin = TRUE, fig.cap = "Prediction success from AdaBoost applied to a WEAK learner. AdaBoost begins with a classificatation just slightly better than chance and gradually improves with more iterations.", fig.width=3.5, fig.height=3.5, cache=TRUE, message=FALSE}
par(bg = '#fffff8')
...
``` {r boostplotstrong, echo=FALSE, fig.margin = TRUE, fig.cap = "Prediction success from AdaBoost using a STRONG learner. Here AdaBoost starts off predicting well but improvement is not as good as it is with the weak learner above.", fig.width=3.5, fig.height=3.5, cache=TRUE, message=FALSE}
par(bg = '#fffff8')
plot(success.vec[1:100], pch=19, col="#6BAED6",
     main="",
     xlab= "Iteration", ylab= "% Prediction success", ylim=c(.5, .9)) 
...
``` {r boostplotnoise, echo=FALSE, fig.margin = TRUE, fig.cap = "Prediction success from AdaBoost and a NOISE learner. Even with noise data, AdaBoost improves prediction above chance after 100 iterations.", fig.width=3.5, fig.height=3.5, cache=TRUE, message=FALSE }
par(bg = '#fffff8')
plot(success.vec[1:100], pch=19, col='#6BAED6',
     xlab= "Iteration", ylab= "% Prediction success", ylim=c(.5, .9)) 
```
